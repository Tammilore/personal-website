...
> 👋🏽 Hi there. Latest update starts [here](#build-out-the-endpoints).
...
> 📌 I'll be releasing the third update for the build next Monday. If you're subscribed to my newsletter, you'll receive the update before I share it publicly. Catch you next week!
...
> 🔔 Remember that for metrics like `support_minutes`, the values are not the actual cost. [Here’s the explanation](https://www.notion.so/Mixpanel-style-analytics-for-customer-unit-economics-Private-e89ec78d2a174ae89487d237824447ea?pvs=21). The calculations for the cost are in the analytics API.

Here’s how a bar chart for this would look:

![Screenshot 2024-01-01 113759.png](/blog/mixpanel-build/Screenshot 2024-01-01 113759.png)
...
https://visualize.graphy.app/view/90888455-133e-4802-a0db-9c7d467492e2
...
https://graphy.app/view/c1cc5d13-8a74-4171-81dd-b3ca2033c1f9
