...
Steps for authenticating the API with API keys are available to subscribers of my newsletter. Additional build steps are always sent before the next update on the blog.
