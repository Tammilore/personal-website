...
description: How I pick what to work on next.
date: 04-03-2024
---
...
There a bunch of reasons why I find it hard to pick an idea to work on but before I get to that, there are a few things on coming up with new ideas that I don't entirely subscribe to.
...
I recently discontinued [Zing](https://www.zingfi.co/) but I'm excited to see use cases for payroll data soon. To finally wrap it up, I'm working on an open-source transaction enrichment engine. Fingers crossed.

I'm trying to decide what my next idea should be. I'm very stuck on the concept of actionable AI. Artificial Intelligence that further closes the gap between insight and action. AI that acts. I'm at the stage where I'm trying to figure out how it works, hopefully it gets past that.

If any of the things I write or build interest you, consider [subscribing to my newsletter](https://tamilore.co/mailing-list).
